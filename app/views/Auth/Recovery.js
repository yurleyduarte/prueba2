    ...
    return (
        <SafeAreaView style={styles.body}>
            ...
            <View style={styles.container}>
                <Text style={styles.label}>Recuperar</Text>
                <GrayInput label={'Correo electrónico'} keyboardType={'email-address'} />
                <Button text={'Continuar'} onPress={() => navigation.replace('ConfirmCode')} />
            </View>
        </SafeAreaView>
    );
}
